...
app.put('/api/solicitacoes/:id/status', requireLogin(['psicopedagoga']), async (req, res) => {
    ...
    let statusAntigo = null; // 1. Declare a variável ANTES do try com 'let'
    ...
    try {
        ...
        statusAntigo = solicitacao.status; // 2. ATRIBUA o valor aqui (sem 'const')
       ...
       const dadosUpdate = {
        ...
        // 3. Agora o 'catch' PODE usar a variável 'statusAntigo'
